...
class TestCrudArtists(unittest.TestCase):
    def test_get_artists_ids(self):
        # Given
        expected_result = ['0lAWpj5szCSwM4rUMHYmrr', '6XyY86QOPPrYVGvF9ch6wz', '3bmFPbLMiLxtR9tFrTcKcP']
    ...
    def test_insert_artist(self):
        # Given
        expected_result = ['0lAWpj5szCSwM4rUMHYmrr', '6XyY86QOPPrYVGvF9ch6wz', '3bmFPbLMiLxtR9tFrTcKcP', '0C0XlULifJtAgn6ZNCW2eu']
        artist = Artist(
            id="0C0XlULifJtAgn6ZNCW2eu",
            name="The Killers",
            popularity=75,
            genres=["alternative rock", "dance rock", "modern rock", "permanent wave",
                    "rock"],
            followers=7281678,
            image_url="hhttps://i.scdn.co/image/ab6761610000e5eb207b21f3ed0ee96adce3166a",
        )
        user_id = "abc123def456"

        # When
        crud_artists.insert_artist(artist, user_id)
